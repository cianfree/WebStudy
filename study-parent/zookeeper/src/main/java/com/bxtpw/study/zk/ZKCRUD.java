...
public class ZKCRUD implements Watcher {
    private static class PropertiesDynLoading {
        ...
        public static final String connectString = "192.168.137.90:9181";
        public static final int sessionTimeout = 3000;
        public static final String authScheme = "digest";
        public static final String accessKey = "password";
    ...
    public void closeZk() {
        if (isConnected()) {
            try {
                zk.close();
                this.log("release zookeeper [{}]", "success");
    ...
    public List<ACL> getCreateNodeAcls() {
        ...
        try {
            ...
            ACL acl = new ACL(ZooDefs.Perms.CREATE, id);
            listAcls.add(acl);
